...
class AmendRegistrationController @Inject() (
  ...
  private def buildContactNamePage(
    ...
    contactNamePage(form,
                    ...
                    routes.AmendRegistrationController.updateContactName()
    )
  ...
  private def buildJobTitlePage(
    ...
    jobTitlePage(form,
                 routes.AmendRegistrationController.displayPage(),
                 routes.AmendRegistrationController.updateJobTitle()
    )
  ...
  private def buildEmailPage(
    ...
    emailPage(form,
              routes.AmendRegistrationController.displayPage(),
              routes.AmendRegistrationController.updateEmail()
    )
  ...
  private def buildPhoneNumberPage(
    ...
    phoneNumberPage(form,
                    routes.AmendRegistrationController.displayPage(),
                    routes.AmendRegistrationController.updatePhoneNumber()
    )
  ...
  private def buildAddressPage(form: Form[Address])(implicit request: JourneyRequest[AnyContent]) =
    addressPage(form,
                ...
                routes.AmendRegistrationController.displayPage(),
                routes.AmendRegistrationController.updateAddress()
    )
