...
package uk.gov.hmrc.plasticpackagingtax.registration.forms.address

import play.api.data.Form
import play.api.data.Forms.{mapping, optional, text}
import uk.gov.hmrc.plasticpackagingtax.registration.forms.{CommonFormValidators, CommonFormValues}

object UkAddressForm extends CommonFormValidators with CommonFormValues {

  val emptyError = "ukAddress.empty.error"
  val field      = "ukAddress"
