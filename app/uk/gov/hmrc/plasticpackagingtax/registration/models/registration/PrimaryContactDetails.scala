...
case class PrimaryContactDetails(
  ...
  def isCompleted: Boolean = fullName.isDefined && jobTitle.isDefined && phoneNumber.isDefined

  def isInProgress: Boolean = fullName.isDefined || jobTitle.isDefined || phoneNumber.isDefined
