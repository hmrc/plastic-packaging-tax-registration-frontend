...
case class GrsLimitedPartnershipDetails(
  sautr: String,
  postcode: String,
...
object GrsLimitedPartnershipDetails {

  implicit val format: OFormat[GrsLimitedPartnershipDetails] =
    Json.format[GrsLimitedPartnershipDetails]

}

case class LimitedPartnershipDetails(
  sautr: String,
  postcode: String,
...
object LimitedPartnershipDetails {
  implicit val format: OFormat[LimitedPartnershipDetails] = Json.format[LimitedPartnershipDetails]

  def apply(grsLimitedPartnershipDetails: GrsLimitedPartnershipDetails): LimitedPartnershipDetails =
    LimitedPartnershipDetails(sautr = grsLimitedPartnershipDetails.sautr,
                              ...
                              registration = Some(
                                RegistrationDetails(
                                  ...
                                  verificationStatus =
                                    grsLimitedPartnershipDetails.businessVerification.map { bv =>
