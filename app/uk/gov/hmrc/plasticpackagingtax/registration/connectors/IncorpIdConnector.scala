...
@Singleton
class IncorpIdConnector @Inject() (httpClient: HttpClient, config: AppConfig, metrics: Metrics)(
  ...
  def createJourney(payload: IncorpIdCreateRequest)(implicit hc: HeaderCarrier): Future[String] = {
    ...
    httpClient.POST[IncorpIdCreateRequest, HttpResponse](config.incorpJourneyUrl, payload)
