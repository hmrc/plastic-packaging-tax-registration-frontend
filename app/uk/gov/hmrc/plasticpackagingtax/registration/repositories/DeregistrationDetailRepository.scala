...
import uk.gov.hmrc.plasticpackagingtax.registration.repositories.DeregistrationDetailsRepository.repositoryKey
...
@Singleton
class DeregistrationDetailRepositoryImpl @Inject() (userDataRepository: UserDataRepository)
