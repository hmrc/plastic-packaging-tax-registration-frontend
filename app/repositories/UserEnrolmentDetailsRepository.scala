...
@Singleton
class UserEnrolmentDetailsRepository @Inject() (userDataRepository: UserDataRepository)(implicit
  executionContext: ExecutionContext
) {

  def put(registration: UserEnrolmentDetails)(implicit
    request: AuthenticatedRequest[Any]
  ): Future[UserEnrolmentDetails] =
  ...
  def update(update: UserEnrolmentDetails => UserEnrolmentDetails)(implicit
    request: AuthenticatedRequest[Any]
  ): Future[UserEnrolmentDetails] =
