...
liability.expectToExceedThreshold.date.none = Nodwch y dyddiad yr oedd gennych sail resymol dros gredu y byddech yn cyrraedd y trothwy 10,000kg cyn pen 30 diwrnod
liability.expectToExceedThreshold.date.invalid = Mae’n rhaid i’r dyddiad fod yn ddyddiad go iawn
liability.expectToExceedThreshold.date.future = Mae’n rhaid i’r dyddiad fod heddiw neu yn y gorffennol
liability.expectToExceedThreshold.two.required.fields = Mae’n rhaid i’r dyddiad gynnwys y {0}
liability.expectToExceedThreshold.one.field = Mae’n rhaid i’r dyddiad gynnwys y {0}
