...
class ContactDetailsEmailAddressPasscodeControllerSpec extends ControllerSpec with DefaultAwaitTimeout {
  ...
  "return prepopulated form" when {
    ...
    def pageForm: Form[EmailAddressPasscode] = {
      ...
      verify(page).apply(
        ...
        ArgumentMatchers.eq(routes.ContactDetailsEmailAddressPasscodeController.submit),
        any()
      )(any(), any())
