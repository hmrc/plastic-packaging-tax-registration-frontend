...
class ExpectToExceedThresholdWeightControllerSpec extends ControllerSpec {
  ...
  private val mockPage: expect_to_exceed_threshold_weight_page =mock[expect_to_exceed_threshold_weight_page]
  private val form = mock[ExpectToExceedThresholdWeight]
