...
trait AmendGroupControllerSpec extends ControllerSpec with MockAmendmentJourneyAction {
  ...
  object FakeAuthNoEnrolmentCheckAction extends AuthNoEnrolmentCheckAction {
    ...
    override def parser: BodyParser[AnyContent] =
      Helpers.stubControllerComponents().parsers.defaultBodyParser
  ...
  object FakeAmendmentJourneyAction extends AmendmentJourneyAction {
    ...
    override protected def refine[A](
      ...
      val jr = JourneyRequest(authenticatedRequest = request,
    ...
    override def updateLocalRegistration(updateFunction: Registration => Registration)(implicit
      request: AuthenticatedRequest[Any]
    ): Future[Registration] = ???

    override def updateRegistration(updateFunction: Registration => Registration)(implicit
      request: AuthenticatedRequest[Any],
