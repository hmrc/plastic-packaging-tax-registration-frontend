              ...
              GroupDetail(
                ...
                members = Seq(
                  GroupMember(
                    ...
                    organisationDetails = Some(GroupMemberOrganisationDetails("Uk Limited", "Subsidiary 1", Some("XP00123"))),
                    addressDetails =
                  ...
                  GroupMember(
                    ...
                    organisationDetails = Some(GroupMemberOrganisationDetails("Uk Limited", "Subsidiary 2", Some("XP00123"))),
                    addressDetails =
    ...
    s"registering a $registrationType" when {
      "displaying organisation details section" when {
        ...
        def getValueFor(index: Int, view: Document) =
          view.getElementsByClass("govuk-summary-list").get(0).getElementsByClass("govuk-summary-list__value").get(index).text()
        ...
        "registering uk company" in {
          ...
          getKeyFor(2, ukCompanyView) must containMessage("reviewRegistration.organisationDetails.businessRegistrationNumber")
          getKeyFor(3, ukCompanyView) must containMessage("reviewRegistration.organisationDetails.uniqueTaxpayerReference")
          getKeyFor(4, ukCompanyView) must containMessage("reviewRegistration.organisationDetails.registeredBusinessAddress")
          ...
          getValueFor(2, ukCompanyView) mustBe ukCompanyRegistration.organisationDetails.incorporationDetails.get.companyNumber
          getValueFor(3, ukCompanyView) mustBe ukCompanyRegistration.organisationDetails.incorporationDetails.get.ctutr.get
        ...
        "registering sole trader" in {
          ...
          getKeyFor(1, soleTraderView) must containMessage("reviewRegistration.organisationDetails.soleTrader.firstName")
          ...
          getKeyFor(5, soleTraderView) must containMessage("reviewRegistration.organisationDetails.registeredBusinessAddress")

          getValueFor(0, soleTraderView) mustBe OrgType.displayName(OrgType.SOLE_TRADER)
          getValueFor(1, soleTraderView) mustBe soleTraderRegistration.organisationDetails.soleTraderDetails.get.firstName
          getValueFor(2, soleTraderView) mustBe soleTraderRegistration.organisationDetails.soleTraderDetails.get.lastName
          getValueFor(3, soleTraderView) mustBe soleTraderRegistration.organisationDetails.soleTraderDetails.get.dateOfBirth.get
          getValueFor(4, soleTraderView) mustBe soleTraderRegistration.organisationDetails.soleTraderDetails.get.ninoOrTrn
        ...
        "registering partnership" in {
          ...
          getKeyFor(2, partnershipView) must containMessage("reviewRegistration.organisationDetails.registeredBusinessAddress")
