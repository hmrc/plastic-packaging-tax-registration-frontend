...
lazy val scoverageSettings: Seq[Setting[_]] = Seq(
  coverageExcludedPackages := List(
    ...
    ".*.views.html.amendment.partner.confirm_remove_partner_page",
    ".*.views.html.amendment.partner.list_partners_page",
    ".*.views.html.amendment.partner.manage_partners_page",
  ).mkString(";"),
